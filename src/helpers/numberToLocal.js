...
const customCurrencyFormatter = (value, currency = 'UAH', currencyDisplay = 'code') => {
  const formatterUAH = new Intl.NumberFormat(locale, {
    style: 'currency',
    currency,
    currencyDisplay, // інші варіанти: 'code', 'name', 'symbol'
    minimumFractionDigits: 0,
    maximumFractionDigits: 2,
  })
  return formatterUAH.format(value)
}
...
export { currencyFormatter, percentFormatter, integerFormatter, customCurrencyFormatter }
